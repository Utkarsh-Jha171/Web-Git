    ...
    attachEventListeners() {
      ...
      if (this.players.length > 0) {
        ...
        if (currentPlayer) {
          ...
          // Compose vehicle info for updates
          const playerVehicle = sessionStorage.getItem('vehicle') || sessionStorage.getItem('vehicleType') || 'car';
          const playerVehicleModel = sessionStorage.getItem('bikeModel') || null;
          ...
          if (this.isHost) {
            ...
            this.sendToHost({
              ...
              vehicleModel: playerVehicleModel
            });
          }
        }
      ...
      fetch(`https://mankydanky.pythonanywhere.com/api/party-codes/lookup/${code}/`)
        ...
        .then(data => {
          ...
          conn.on('open', () => {
            ...
            // Send player info to host with color and vehicle selection
            conn.send({
              type: 'joinRequest',
              playerId: this.playerId,
              playerName: this.playerName,
              playerColor: sessionStorage.getItem('carColor') || 'red',
              vehicle: sessionStorage.getItem('vehicle') || sessionStorage.getItem('vehicleType') || 'car',
              vehicleModel: sessionStorage.getItem('bikeModel') || null
            });
          ...
          if (this.isHost) {
            ...
            if (playerIndex !== -1) {
              ...
              if (typeof data.vehicle !== 'undefined') {
                this.players[playerIndex].vehicle = data.vehicle;
              }
              if (typeof data.vehicleModel !== 'undefined') {
                this.players[playerIndex].vehicleModel = data.vehicleModel;
              }
    ...
    startMultiplayerGame() {
      ...
      if (this.players.length === 0) {
        ...
        if (hostIndex !== -1) {
          ...
          this.players[hostIndex].vehicle = sessionStorage.getItem('vehicle') || sessionStorage.getItem('vehicleType') || 'car';
          this.players[hostIndex].vehicleModel = sessionStorage.getItem('bikeModel') || null;
        }
      }
